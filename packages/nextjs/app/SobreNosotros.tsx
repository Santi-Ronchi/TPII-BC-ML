                                ...
                                <div className="px-4 md:px-0 lg:w-6/12">
                                    <div className="md:mx-6 md:p-12">
                                        <section className="flex flex-col items-center justify-center p-8 bg-gray-100">
                                            <h1 className="text-5xl font-extrabold text-gray-800 tracking-wide mb-6">
                                                ¿Quiénes somos?
                                            </h1>
                                            <p className="text-lg leading-relaxed text-gray-700 max-w-4xl text-center">
                                                En <span className="font-bold text-purple-600">Arpa</span>, transformamos la industria inmobiliaria mediante la innovación tecnológica. Nuestro objetivo es ofrecer soluciones modernas y eficientes para simplificar el proceso de alquiler de propiedades.
                                            </p>
