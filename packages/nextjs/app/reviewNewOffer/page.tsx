...
export const ProposeNewOfferPage = () => {
  ...
  return(
    ...
    <div className="px-6 pt-10 pb-8 shadow-xl sm:my-auto bg-secondary sm:mx-auto sm:max-w-11/12 md:w-9/12 sm:w-11/12 sm:rounded-lg sm:px-10"
      ...
      <AddressInput value={contractIdString} placeholder="Ingrese el ID del contrato" onChange={function (newValue: string): void {
      ...
      <EtherInput value={ethAmount} onChange={amount => setEthAmount(amount) } placeholder="Ingrese el nuevo precio sugerido"/>
      <br /><br />
      ...
      }} placeholder="Ingrese la nueva penalidad sugerida"></IntegerInput>
      <br /><br />
      ...
      }} placeholder="Ingrese el nuevo nuemero de dias sugerido para realizar el pago mensual"></IntegerInput>
