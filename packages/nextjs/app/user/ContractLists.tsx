...
const ContractLists: React.FC<ContractListsProps> = ({ contracts, handleContractChange }) => {
  ...
  return (
    <div
      className="w-full bg-white dark:bg-gray-800 bg-opacity-90 dark:bg-opacity-90 p-6 rounded-lg shadow-md"
              ...
              {contracts
                ...
                .map(contract => (
                  ...
                  >
                    ...
                    <p className="text-gray-700 dark:text-gray-300">Duración del contrato: {contract.duration} meses</p>
                    <p className="text-gray-700 dark:text-gray-300">Interés: {contract.interest}%</p>
                    <p className="text-gray-700 dark:text-gray-300">
                      Billetera del dueño: <span className="font-semibold">{contract.ownerAddress}</span>
                    </p>
                    <p className="text-gray-700 dark:text-gray-300">
                      Billetera del inquilino: <span className="font-semibold">{contract.lesseAddress}</span>
                    </p>
