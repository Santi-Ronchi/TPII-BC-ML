...
const RegisterPage: NextPage = () => {
  ...
  return (
    <section className="" >
      <div className="h-full p-10" style={{ backgroundColor: 'rgba(203, 207, 211, 0.5)' }}>
        <div className="g-6 flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
          <div className="w-full" style={{ backgroundColor: 'rgba(203, 207, 211, 0.5)' }}>
            <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-800">
              <div className="g-0 lg:flex lg:flex-wrap">
                {/* <!-- Right column container with background and description (moved to the left)--> */}
                ...
                {/* <!-- Left column container (moved to the right)--> */}
