...
import { Bars3Icon, BugAntIcon, HomeIcon, BriefcaseIcon, HomeModernIcon, CalculatorIcon, UserCircleIcon } from "@heroicons/react/24/outline";
        ...
        return (
          <li key={href}>
            <Link
              ...
              } hover:bg-secondary hover:shadow-md focus:!bg-secondary active:!text-neutral py-1.5 px-3 text-sm rounded-full gap-2 grid gr
d-flow-col`}
            >
              {icon}
              <span>{label}</span>
